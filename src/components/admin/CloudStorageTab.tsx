...
import { 
  ...
  testMegaConnection, uploadToMegaStorage, deleteStorageFile, 
          ...
          <div className="bg-slate-900/50 p-6 rounded-2xl border border-white/10 space-y-6">
            <div className="flex items-center justify-between border-b border-white/10 pb-4">
              <div>
                <h3 className="text-lg font-bold text-white flex items-center gap-2">
                  ...
                  إعدادات التخزين السحابي (Storage Settings)
                </h3>
                <p className="text-xs text-slate-400 mt-1">
                  معلومات الاتصال بحساب خادم MEGA ومجلد التخزين الرئيسي.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-slate-950/60 p-4 rounded-xl border border-white/5 space-y-1 md:col-span-2">
                <span className="text-xs text-slate-400 font-medium">مجلد MEGA الرئيسي المستهدف (MEGA Folder)</span>
